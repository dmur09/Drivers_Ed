...
public static class SpriteTools
{
    ...
    public static Vector3 RandomTrackScreenLocation()
    {
        //need to change to to the width/height of the track
    ...
    public static Vector3 RandomTrackWorldLocation()
    {
        Vector3 randomTrackLocation = RandomTrackScreenLocation();
        return Camera.main.ScreenToWorldPoint(randomTrackLocation);
    }
